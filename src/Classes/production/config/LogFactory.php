<?php
// File: src/Classes/production/config/LogFactory.php
...
class LogFactory
{
    ...
    public static function getLogger($name = 'Application')
    {
        ...
        if (self::$logger === null) {
            ...
            self::$logger->pushHandler(new StreamHandler(__DIR__ . '/../../logs/production_errors.log', Logger::ERROR));
            self::$logger->pushHandler(new StreamHandler(__DIR__ . '/../../logs/production_Info.log', Logger::INFO));
