<?php
// File: src/Classes/quality/Config/LogFactory.php

namespace Quality\Config;
...
class LogFactory
{
    ...
    public static function getLogger($name = 'Application')
    {
        ...
        if (self::$logger === null) {
            ...
            self::$logger->pushHandler(new StreamHandler(__DIR__ . '/../logs/quality_errors.log', Logger::ERROR));
            self::$logger->pushHandler(new StreamHandler(__DIR__ . '/../logs/quality_info.log', Logger::INFO));
