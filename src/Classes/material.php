...
Class material
{
    ...
    public function get_MaterialName()
    {
        try {
    ...
    public function update($materialPartNumber,$materialName,$productID,$minLbs,$customer)
    {
        try
        {
            $stmt = $this->con->prepare("UPDATE material SET MaterialPartNumber = : materialPartNumber, 
                                            SET MaterialName = :materialName, 
                                            SET ProductID = :productID, 
                                            SET MinimumLbs = :minLbs, 
                                            SET customer = :customer 
                                            WHERE MaterialPartNumber = :materialPartNumber");
