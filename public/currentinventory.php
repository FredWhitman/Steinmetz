                        ...
                        <div class="card-body">
                            <div class="table responsive-md w-33" style="height:450px; overflow-y: auto">
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    <thead>
                                        <tr><th class="text-center">Part Number</th><th class="text-center">Part Name</th><th class="text-center">Qty in Stock</th>
                                    </thead>
                                        <?PHP try {$parts = $inventoryObj->get_Parts();} catch (PDOException $e) { echo $e->getMessage();} ?>
                                    <tbody>
                                        <?php if($parts != Null){while($rowParts = $parts->fetch(PDO::FETCH_ASSOC)){?>
                                        <tr>
                                           ...
                                           <?php }else print($rowParts["PartQty"]); ?></td>
                                        </tr>
                                         <?php }}?>
                                    </tbody>   
                                </table>    
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive w-33" style= "height:450px; overflow-y: auto">
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    <thead>
                                        <tr><th class="text-center">Material Number</th><th class="text-center">Material Name</th><th class="text-center">Lbs in Stock</th></tr>
                                    </thead>
                                    <tbody>
                                            <?php try { $material = $inventoryObj->get_Material(); } catch (PDOException $e) { echo $e->getMessage();} ?>
                                            <tr><?Php if($material->rowcount()>0){while($rowMaterials = $material->fetch(PDO::FETCH_ASSOC)){?>
                                                ...
                                                <td class="text-center"><?php if ($rowMaterials["Minimumlbs"] > $rowMaterials["lbs"]) { ?>
                                                    ...
                                                    <?php }else print($rowMaterials["lbs"]);?> </td>
                                            </tr><?php }}?>
                                    </tbody>
                                </table>    
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive" style="height:450px; overflow-y: auto">
                                <table class="table table-striped table-bordered table-hover table-sm">
                                    <thead>
                                        <tr><th class="text-center">PFM Part Number</th><th class="text-center">PFM Part Name</th><th class="text-center">Qty in Stock</th></tr>
                                    </thead>
                                    <tbody>
                                        <?php $pfms = $inventoryObj->get_Pfms();?>
                                        <tr><?php if ($pfms->rowcount()>0){while($rowPfms = $pfms->fetch(PDO::FETCH_ASSOC)){?>
