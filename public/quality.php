        ...
        <div class="mt-5">
            ...
            <ul class="nav nav-tabs" id="qualityTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="qa-rejects-tab" data-bs-toggle="tab" data-bs-target="#qa-rejects" type="button" role="tab" aria-controls="qa-rejects" aria-selected="true">QA Rejects</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="oven-logs-tab" data-bs-toggle="tab" data-bs-target="#oven-logs" type="button" role="tab" aria-controls="oven-logs" aria-selected="false">Oven Logs</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="lot-change-logs-tab" data-bs-toggle="tab" data-bs-target="#lot-change-logs" type="button" role="tab" aria-controls="lot-change-logs" aria-selected="false">Lot Change Logs</button>
                </li>
            </ul>

            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="qa-rejects" role="tabpanel">
                ...
                <div class="tab-pane fade" id="oven-logs" role="tabpanel">
                    <div class="table-container">
                ...
                <div class="tab-pane fade" id="lot-change-logs" role="tabpanel">
                    <div class="table-container">
