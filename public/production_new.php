...
<head>
    ...
    <link href="/css/addProdLog.css" rel="stylesheet">
                            ...
                            <div class="col w-50">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row justify-content-center"> Daily Usage</div>
                                        <div class="row row-cols-4">
                                            <div class="col-1"></div>
                                            <div class="col-5">Lbs Used</div>
                                            <div class="col-2">%</div>
                                            <div class="col">Production</div>
                                        </div>
                                        <!-- Hoper 1 Row -->
                                        <div class="row">
                                            <div class="col-1"></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input class="form-control" tabindex="14" type="number" name="pressCounter" id="pessCounter" required>
                                            </div>
                                        </div>
                                        <!-- Hopper 3 row -->
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input class="form-control" tabindex="15" type="number" name="startUpRejects" id="startUpRejects" required>
                                            </div>
